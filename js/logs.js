...
function getEventStatus(eventType) {
  if (eventType === 'critical' || eventType === 'bfp_alert') return 'critical';
  if (eventType === 'warning' || eventType === 'manual_alarm_on') return 'warning';
...
async function filterLogs() {
  ...
  const criticalOnly = criticalToggle.checked;
...
criticalToggle.addEventListener("change", filterLogs);
